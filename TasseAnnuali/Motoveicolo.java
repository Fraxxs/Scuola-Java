...
public class Motoveicolo
{
    ...
    Motoveicolo(String targa, String marca, String modello, int annoImmatricolazione, int passeggeriAggiuntivi, int HP)
    {
      setTarga(targa);
      setMarca(marca);
      setModello(modello);
